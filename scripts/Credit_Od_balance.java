...
public class Credit_Od_balance {
	...
	public Object[][] createData12() throws IOException {
		Object[][] retObjArr = getExcelData(
				"test\\resources\\data\\transaction_od_credit.xlsx", "Sheet1");
		System.out
	...
	public void register1(String operation1, String operation2,
			String Member_id, String acc_number, String Transaction_type,
			String Instrument_type, String chequeno, String Transaction_code,
			String Credit_Amount) throws InterruptedException {
		object.transaction(operation1, operation2, Member_id, acc_number,
				Transaction_type, Instrument_type, chequeno, Transaction_code,
				Credit_Amount);
	}
