...
public class ODBalance {
	 ...
	 public void setup() throws InterruptedException
	 {
	  ...
	  object=new POMODBalance(driver,builder);
	...
	@DataProvider(name="Sheet1")
	  ...
	  {
	       Object[][] retObjArr=getExcelData("test\\resources\\data\\transaction_od_bal.xlsx","Sheet1");
	       System.out.println("*****************  Data Accessed *************************");
	       return(retObjArr);
	   }
	 @Test(dataProvider = "Sheet1")
	 public void register1(String operation,String Member_id,String acc_number,String Transaction_type,String Instrument_type,String chequeno,String Transaction_code,String Amount) throws InterruptedException
	 {
