package transaction_voucher_gen;
import java.io.File;
...
public class VoucherGeneration {
	 ...
	 public void setup() throws InterruptedException
	 {
	  ...
	  object=new POMVoucher(driver,builder);
	...
	@DataProvider(name="Sheet1")
	  ...
	  {
	       Object[][] retObjArr=getExcelData("test\\resources\\data\\transaction_voucher_excel.xlsx","Sheet1");
