...
public class VoucherGeneration {
	...
	public Object[][] createData12() throws IOException {
		Object[][] retObjArr = getExcelData(
				"test\\resources\\data\\transaction_voucher_excel.xlsx",
				"Sheet1");
		System.out
	...
	public void register1(String operation, String Member_id,
		...
		object.transaction(operation, Member_id, acc_number, Transaction_type,
				Instrument_type, chequeno, Transaction_code, Amount);
	}
