...
public class POM_MultipleAccounts {
	    ...
	    By search_pop1=	By.cssSelector("#select_2_chosen > div:nth-child(2) > div:nth-child(1) > input:nth-child(1)");
	    By search_pop2=By.cssSelector("#select_3_chosen > div:nth-child(2) > div:nth-child(1) > input:nth-child(1)");
		...
		public POM_MultipleAccounts(WebDriver driver,Actions builder)
		 ...
		 public void transaction(String operation,String Member_id,String acc_number,String acc_1,String acc_2,String amt_1,String amt_2,String Transaction_type,String Instrument_type,String chequeno,String Transaction_code
		  ...
		  // TODO Auto-generated method stub
			 ...
			 String amount_text=driver.findElement(amt_textbox).getAttribute("value");
