package transaction_credit_debit;
import java.io.File;
...
public class CreditDebit {
	 ...
	 public void setup() throws InterruptedException
	 {
	  ...
	  object=new POM_CreditDebit(driver,builder);
	...
	@DataProvider(name="Sheet1")
	  ...
	  {
	       Object[][] retObjArr=getExcelData("test\\resources\\data\\transaction.xlsx","Sheet1");
	       System.out.println("*****************  Data Accessed *************************");
	       return(retObjArr);
	   }
	 @Test(dataProvider = "Sheet1")
	 public void register1(String operation,String Member_id,String acc_number,String Transaction_type,String Instrument_type,String chequeno,String Transaction_code,String Amount) throws InterruptedException, IOException
	 {
		object.transaction(operation,Member_id,acc_number,Transaction_type,Instrument_type,chequeno,Transaction_code,Amount);
	 }
