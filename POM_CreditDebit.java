...
public class POM_CreditDebit {
    ...
    By instru_type_message=By.xpath("//*[@id='instrumenttype_chosen']/div/ul/li");
	public POM_CreditDebit(WebDriver driver,Actions builder)
	 ...
	 public void transaction(String operation,String Member_id,String acc_number,String Transaction_type,String Instrument_type,String chequeno,String Transaction_code,String Amount
		 ...
		 driver.findElement(transaction_entry).click(); //click on transaction entry
		 driver.findElement(reciept).click();   //click on receipt
		 
		 driver.findElement(drop_memberid1).click();
		 Assert.assertEquals(Member_id.equals(""),false, "Member id field is blank");
		  ...
		  Thread.sleep(2000);
			 Assert.assertEquals(accno_textbox1.equals(""),false,"Account number field is blank");
